...
// Update the row if there is one, create it if not. (An ON DUPLICATE KEY
// UPDATE used here once never updated anything and wrote a column that does
// not exist.) A failed write throws, so there is no "false" to report.
